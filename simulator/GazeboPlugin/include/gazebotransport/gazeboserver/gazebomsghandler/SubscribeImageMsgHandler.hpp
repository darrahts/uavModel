...
public:
  ...
  */
  explicit SubscribeImageMsgHandler(gazebo::physics::WorldPtr world, gazebo::transport::NodePtr node);
...
private:
  ...
  virtual std::string getTopicName(Packet const &msgContent) override;

  /// do subscribe to image message
  void doSubscribe(gazebo::physics::WorldPtr world, gazebo::transport::NodePtr node, Packet const &msgContent) override;
};
} // namespace gazebotransport
} // namespace robotics
#endif
