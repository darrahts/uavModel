...
public:
  ...
  /*
    ...
    */
  LinkPtrStorage(gazebo::physics::LinkPtr linkPtr, ::gazebo::common::Time endTime, Packet const &msgContent)
      : m_linkPtr(linkPtr), m_endTime(endTime), m_msgContent(msgContent)
  {
  }
