...
public:
  ...
  /*
    ...
    */
  JointPtrStorage(gazebo::physics::JointPtr jointPtr, ::gazebo::common::Time endTime, Packet const &msgContent)
      : m_jointPtr(jointPtr), m_endTime(endTime), m_msgContent(msgContent)
  {
  }
