    ...
    namespace gazebotransport
    {
        ...
        class SensorContainer
        {
             ...
             * @param sensor                        Sensor to insert into the container. 
                                                    Insertion will only happen if sensor for its topic is not already in the container
             * @return                              A pair. First points to the sensor that is stored in the container
             *                                      Second indicates whether insertion happened or not.
            */
            std::pair<std::shared_ptr<GazeboSensorSubscriber>, bool> insert(std::shared_ptr<GazeboSensorSubscriber> sensor);

            /// find sensor based on topic name
            /// @return                             The sensor that is stored in the container and matches the topic name
