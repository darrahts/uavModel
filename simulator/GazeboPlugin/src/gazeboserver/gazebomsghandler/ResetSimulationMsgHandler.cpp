...
ResetSimulationMsgHandler::ResetSimulationMsgHandler(std::shared_ptr<GazeboWorldInterface> ptr) : m_ptr(ptr)
{
}
...
std::string ResetSimulationMsgHandler::handleMessage(Packet const &msgContent)
{
...
{
    return robotics::gazebotransport::PacketHeader_MsgID_RESET_SIMULATION; // Message ID from MsgTable
}
} // namespace gazebotransport
} // namespace robotics
