...
TEST_F(getModelInfoTest, testModelNames)
{
    ...
    m_message.mutable_header()->set_id(robotics::gazebotransport::PacketHeader_MsgID::PacketHeader_MsgID_GET_MODEL_INFO);
    ...
    /// The received model info is compared with default gazebo model like "ground_plane" & link "link"
    /// Also, the ground truth model, link and joint names are given with .world file
    /// as "unit_box", "link" & "joint"
